...
/// <summary>
/// Equity Asian (average-rate / average-strike) option pricer — arithmetic or
...
/// </summary>
public sealed class EQAsianOptionMCPricer : GbmOptionMCPricer
{
    ...
    protected override MCBasePricer CreateBumped(BumpType bump, double epsilon)
    {
        ...
        return new EQAsianOptionMCPricer(OptionDef, ValuationDate, vol, Cube);
    }
}
